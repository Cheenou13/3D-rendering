...
let walking = '/GLBModels/EmployeePoses/operatingAnimationV2.glb'
...
export async function loadModel() {
    ...
    // const operatingAnime = extractModel(walkingData)
    // operatingAnime.scale.set(0.5, 0.5, 0.5)

    // const mixer = new AnimationMixer(operatingAnime)
    ...
    // operatingAnime.position.set(-4, -1.35, -1.23)
