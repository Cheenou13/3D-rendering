...
export async function loadModel() {
    ...
    const producttionLines = productionLinesData.scene
    producttionLines.scale.set(0.4, 0.4, 0.4)
    // if (!producttionLines.children[9].children[0].children[0]) console.log("children null \n", producttionLines.children[9].children[0].children[0])
